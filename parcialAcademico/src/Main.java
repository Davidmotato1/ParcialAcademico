...
public class Main {
    public static void main(String[] args) {
        ...
        Student newStudent = new Student(1234, "David", "davidm@gmail.com");
        ...
        Teacher newTeacher = new Teacher(123, "Maria", "Ingenieria");
        teacherController.insertNewTeacher(newTeacher);
        teacherController.displayAllTeachers();

        Course newCourse = new Course(123, "Tecnologia", "POO, Polimorfismo, Interfaces, UML", true, newTeacher.getId());
        courseController.insertNewCourse(newCourse);
        courseController.displayAllCourses();

        Enrollment newEnrollment = new Enrollment(124, newStudent.getId(), newCourse.getId());
        enrollmentController.insertNewEnrollment(newEnrollment);
        enrollmentController.displayAllEnrollments();

        GradeType newGradeType = new GradeType(111, "Once", 22.5);
